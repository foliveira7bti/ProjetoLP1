...
void ListarAnimais (map<int, MamiferoNativo> &listaDeMamiferosNativos, map<int, MamiferoExotico> &listaDeMamiferosExoticos, 
	...
	map<int, AveNativo> &listaDeAvesNativas, map<int, AveExotico> &listaDeAvesExoticas, 
	map<int, AnfibioNativo> &listaDeAnfibiosNativos, map<int, AnfibioExotico> &listaDeAnfibiosExoticos);
	 		 		...
	 		 		switch(animalOption)
	 		 		{
			 				...
			 				case 5:
		 						...
		 						//ListarAnimais (animais);
		 				 		ListarAnimais (listaDeMamiferosNativos, listaDeMamiferosExoticos, listaDeRepteisNativos, listaDeRepteisExoticos, listaDeAvesNativas, listaDeAvesExoticas, listaDeAnfibiosNativos,listaDeAnfibiosExoticos);
								break;

			 				case 6:	
			 			
			 					//RemoverAnimal(animais);
			 				 	RemoverAnimal(listaDeMamiferosNativos, listaDeMamiferosExoticos, listaDeRepteisNativos, listaDeRepteisExoticos, listaDeAvesNativas, listaDeAvesExoticas, listaDeAnfibiosNativos,listaDeAnfibiosExoticos);
...
void RemoverAnimal(map<int, MamiferoNativo> &listaDeMamiferosNativos, map<int, MamiferoExotico> &listaDeMamiferosExoticos, 
	...
	cout << "Defina o Id do animal que deseja remover: ";
	cin >> id;
		...
		map<int, AveNativo> :: iterator itAN = listaDeAvesNativas.find(id);

	    if(itAN != listaDeAvesNativas.end())
	    {
	        listaDeAvesNativas.erase(itAN);
	     

	    }
		map<int, AveExotico> :: iterator itAE = listaDeAvesExoticas.find(id);

	    if(itAE != listaDeAvesExoticas.end())
	    {
	        listaDeAvesExoticas.erase(itAE);
	       

	    }
		map<int, AnfibioNativo> :: iterator itANFN = listaDeAnfibiosNativos.find(id); 

	    if(itANFN  != listaDeAnfibiosNativos.end())
	    {
	        listaDeAnfibiosNativos.erase(itANFN );


	    }
		map<int, AnfibioExotico> :: iterator itANFE = listaDeAnfibiosExoticos.find(id);

	    if(itANFE != listaDeAnfibiosExoticos.end())
	    {
	        listaDeAnfibiosExoticos.erase(itANFE);
...
/*
	...
	for(auto itAN  = listaDeAvesNativas.begin(); itAN != listaDeAvesNativas.end(); itAN++){
		...
		cout << "Id do animal: " << (itAN->second).getId() << endl;
		cout << "Classe do animal:" << (itAN->second).getClasse() << endl;
		cout << "Nome do animal:" << (itAN->second).getNome() << endl;
		cout << "Nome científico do animal:" << (itAN->second).getCientifico() << endl;
		cout << "Sexo do animal: " << (itAN->second).getSexo()<< endl;
		cout << "Tamanho médio em metros:  " << (itAN->second).getTamanho() << endl;
		cout << "Dieta predominante: " << (itAN->second).getDieta() << endl;
		//cout << "Nome do Veterinario: " << (itAN->second).getVeterinario() << endl;
		//cout << "Nome do Tratador: " << (itAN->second).getTratador() << endl;
		cout << "Nome de batismo: " << (itAN->second).getBatismo() << endl;
		cout << "Animal Exotico ou Nativo: " << (itAN->second).getNativoOUexotico() << endl;
		cout << endl;
	}
	...
	for(auto itAE  = listaDeAvesExoticas.begin(); itAE != listaDeAvesExoticas.end(); itAE++){
		...
		cout << "Id do animal: " << (itAE->second).getId() << endl;
		cout << "Classe do animal:" << (itAE->second).getClasse() << endl;
		cout << "Nome do animal:" << (itAE->second).getNome() << endl;
		cout << "Nome científico do animal:" << (itAE->second).getCientifico() << endl;
		cout << "Sexo do animal: " << (itAE->second).getSexo()<< endl;
		cout << "Tamanho médio em metros:  " << (itAE->second).getTamanho() << endl;
		cout << "Dieta predominante: " << (itAE->second).getDieta() << endl;
		//cout << "Nome do Veterinario: " << (itAE->second).getVeterinario() << endl;
		//cout << "Nome do Tratador: " << (itAE->second).getTratador() << endl;
		cout << "Nome de batismo: " << (itAE->second).getBatismo() << endl;
		cout << "Animal Exotico ou Nativo: " << (itAE->second).getNativoOUexotico() << endl;
		cout << endl;
	}
		...
		cout << "Id do animal: " << (itANFN->second).getId() << endl;
		cout << "Classe do animal:" << (itANFN->second).getClasse() << endl;
		cout << "Nome do animal:" << (itANFN->second).getNome() << endl;
		cout << "Nome científico do animal:" << (itANFN->second).getCientifico() << endl;
		cout << "Sexo do animal: " << (itANFN->second).getSexo()<< endl;
		cout << "Tamanho médio em metros:  " << (itANFN->second).getTamanho() << endl;
		cout << "Dieta predominante: " << (itANFN->second).getDieta() << endl;
		//cout << "Nome do Veterinario: " << (itANFN->second).getVeterinario() << endl;
		//cout << "Nome do Tratador: " << (itANFN->second).getTratador() << endl;
		cout << "Nome de batismo: " << (itANFN->second).getBatismo() << endl;
		cout << "Animal Exotico ou Nativo: " << (itANFN->second).getNativoOUexotico() << endl;
		cout << endl;
	}
	...
	for(auto itANFE  = listaDeAnfibiosExoticos.begin(); itANFE != listaDeAnfibiosExoticos.end(); itANFE++){
		...
		cout << "Id do animal: " << (itANFE->second).getId() << endl;
		cout << "Classe do animal:" << (itANFE->second).getClasse() << endl;
		cout << "Nome do animal:" << (itANFE->second).getNome() << endl;
		cout << "Nome científico do animal:" << (itANFE->second).getCientifico() << endl;
		cout << "Sexo do animal: " << (itANFE->second).getSexo()<< endl;
		cout << "Tamanho médio em metros:  " << (itANFE->second).getTamanho() << endl;
		cout << "Dieta predominante: " << (itANFE->second).getDieta() << endl;
		//cout << "Nome do Veterinario: " << (itANFE->second).getVeterinario() << endl;
		//cout << "Nome do Tratador: " << (itANFE->second).getTratador() << endl;
		cout << "Nome de batismo: " << (itANFE->second).getBatismo() << endl;
		cout << "Animal Exotico ou Nativo: " << (itANFE->second).getNativoOUexotico() << endl;
		cout << endl;
	}
